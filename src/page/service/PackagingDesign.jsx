  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://chameleogfxstudio.com/services/graphic-design/packaging-design-agency"
        />
      </Helmet>
      <BreadCrumb title="Packaging Design Agency in Ahmedabad, India" breadcrumbTitle="Packaging Design Agency in Ahmedabad, India" />
