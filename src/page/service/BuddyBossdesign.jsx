...
function BuddyBossdesign() {
  ...
  return (
    <>
      ...
      <BreadCrumb title="BuddyBoss, LearnDash, and Dokan Design & Development Company in Ahmedabad, India" breadcrumbTitle="BuddyBoss, LearnDash, and Dokan Design & Development Company in Ahmedabad, India" />
