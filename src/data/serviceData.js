...
export const uiuxDesignServices = [
  {
    title: "UI/UX Design",
    items: [
...
export const webDevelopmentServices = [
  {
    ...
    categories: [
      {
        subtitle: "HTML/CSS",
        subtitleLink: "/services/web-development/html-css-development-company",
        items: [
          { text: "HTML/CSS", link: "/services/web-development/html-css-development-company" },
      ...
      {
        subtitle: "Webflow",
        subtitleLink: "/services/web-development/webflow-development-company",
        items: [
          { text: "Webflow", link: "/services/web-development/webflow-development-company" },
      ...
      {
        subtitle: "WordPress",
        subtitleLink: "/services/web-development/wordpress-development-company",
        items: [
          { text: "WordPress", link: "/services/web-development/wordpress-development-company" },
      ...
      {
        subtitle: "Shopify",
        subtitleLink: "/services/web-development/shopify-development-company",
        items: [
          { text: "Shopify", link: "/services/web-development/shopify-development-company" },
          ...
          { text: "Figma to Shopify", link: "/services/web-development/figma-to-shopify-company" },
          { text: "Photoshop to Shopify", link: "/services/web-development/photoshop-to-shopify-company" },
          { text: "HTML to Shopify", link: "/services/web-development/html-to-shopify-company" },
      ...
      {
        subtitle: "React.js",
        subtitleLink: "/services/web-development/react-js-development-company",
        items: [
          { text: "React.js", link: "/services/web-development/react-js-development-company" },
          { text: "Figma to React", link: "/services/web-development/figma-to-react-company" },
          { text: "Photoshop to React", link: "/services/web-development/photoshop-to-react-company" },
          { text: "HTML to React", link: "/services/web-development/html-to-react-company" },
          ...
          { text: "React.js Mobile App Development (React Native)", link: "/services/web-development/reactjs-mobile-app-development-company" },
          { text: "React.js Website Development with Server-Side Rendering (SSR)", link: "/services/web-development/reactjs-ssr-website-development-company" },
