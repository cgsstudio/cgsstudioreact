...
import SingleImg from "../../assets/images/service/Website_Redesign_and_Revamp.jpg";
...
function Websiteredesigndetail() {
  return (
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="aximo-default-content">
                ...
                <p>
                Our redesign process includes upgrading the HTML, CSS, and UI/UX design to meet the latest industry standards. We ensure your website is fully responsive, faster, and optimized for search engines. Whether you need minor visual enhancements or a complete overhaul, our website revamp services are designed to transform your site into a powerful business tool that delivers measurable results.
                </p>
              </div>
            </div>
          </div>
...
export default Websiteredesigndetail;
