		...
		<div className="section  pb-0">
					...
					<div className="row ">
						<div className="col-lg-12">
							<div className="aximo-default-content">
								<h1 className="text-center"><span className="custom-h2"><span style={{ color: 'red' }}>Website Development</span> Company in Ahmedabad</span></h1>
						...
						<div className="col-lg-6">
							<div className="aximo-default-content">
								...
								<ul className="custom-list">
									<li className="m-0" ><b>First impressions count –</b> Your website is usually the first point of contact people have with your business.</li>
									<li className="m-0"><b>Establishes credibility –</b> A fresh, organized site makes your company trustworthy.</li>
									<li className="m-0"><b>Delivers leads and sales –</b> Sites convert visitors into customers with obvious calls to action.</li>
									<li className="m-0"><b>Works 24/7 –</b> Unlike a brick-and-mortar shop, your site is open 24 hours a day, 7 days a week.</li>
									<li className="m-0"><b>Complements marketing efforts –</b> Search engine optimization-friendly sites rank higher on Google and drive organic traffic.</li>
								</ul><br />
					...
					<div className="row">
						...
						<div className="col-lg-6">
							<div className="aximo-default-content">
								...
								<ul className="custom-list">
									<li className="m-0"><b>Custom Website Development –</b> Special websites designed to reflect your brand and objectives.</li>
									<li className="m-0"><b>E-commerce Development –</b> Secure payment online stores and hassle-free shopping websites.</li>
									<li className="m-0"><b>Corporate and Business Websites –</b> Trusted, professional sites that highlight services.</li>
									<li className="m-0"><b>CMS-Based Websites –</b> Simple-to-maintain websites based on WordPress, Shopify, or other software.</li>
									<li className="m-0"><b>Responsive Design –</b> Sites that are a breeze to use on mobiles, tablets, and desktops.</li>
									<li className="m-0"><b>SEO-Friendly Development –</b> Clean code and optimization for better search rankings.</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div className="row">
						<div className="col-lg-6">
							<div className="aximo-default-content">
								...
								<ul className="custom-list">
									<li className="m-0"><b>Discovery –</b> Acquiring a clear vision of your business, objectives, and clientele.</li>
									<li className="m-0"><b>Planning –</b> Creating a clear plan with the appropriate designs and functionalities.</li>
									<li className="m-0"><b>Design & Development –</b> Constructing the site with new tools and technology.</li>
									<li className="m-0"><b>Testing –</b> Vetting speed, performance, and usability.</li>
									<li className="m-0"><b>Launch –</b> Publishing your website live for the world to see.</li>
									<li className="m-0"><b>Support –</b> Offering constant updates, upkeep, and enhancements.</li>
								</ul><br />
								<p>
					...
					<div className="row">
						...
						<div className="col-lg-6">
							<div className="aximo-default-content">
								...
								<ul className="custom-list">
									<li className="m-0"><b>Design + coding skills –</b> We combine style with robust coding.</li>
									<li className="m-0"><b>User-centric –</b> Our sites are straightforward and simple to use.</li>
									<li className="m-0"><b>New tech –</b> We take advantage of the latest tools for performance and security.</li>
									<li className="m-0"><b>Search-engine friendly –</b> All sites we create are optimized for search engines.</li>
									<li className="m-0"><b>Reasonably priced solutions –</b> Excellent sites at affordable rates.</li>
									<li className="m-0"><b>Personalized support –</b> We don't merely construct; we sustain and enhance.</li>
									<li className="m-0"><b>AI-driven strategies –</b> From intelligent recommendations to predictive insights, we future-proof your site.</li>
								</ul><br />
								<p>
			...
			<div className="container pt-5">
				<h1 className="main-heading text-center mb-5">
					Bespoke Website Development Company in<br />Ahmedabad
				</h1>
				...
				<section className="faq-section py-5">
					<div className="container">
						<h2 className="mb-4 text-center">
							<span className="services-h2">FAQs on Website Development</span>
						</h2>
