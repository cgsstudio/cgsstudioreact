				...
				<div className="aximo-service-details-wrap">
					...
					<div className="row">
						<div className="col-lg-12">
							<div className="aximo-default-content">
								...
								<p>
									Web development involves creating, building, and maintaining websites. It includes web design, web programming, and database management.
								</p>
								<p>
									Our web development services help bring your ideas to life with clean, efficient, and scalable code.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="container pt-5">
						{services.map((service, index) => (
							<div key={index}>
								<div className="aximo-section-title main center pt-5">
									<h2>
										<span className="aximo-title-animation">
											{service.title}
											<span className="aximo-title-icon">
