...
import SingleImg from "../../assets/images/service/React.js_Component_Development_and_Integration.jpg";
...
function Reactjscomponentdevelopmentdetail() {
  return (
...
export default Reactjscomponentdevelopmentdetail;
