...
import SingleImg from "../../assets/images/service/HTML_to_Shopify.jpg";
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="aximo-default-content">
                ...
                <p>
                  Our team of Shopify developers in Ahmedabad carefully converts your existing HTML, CSS, and JavaScript files into a fully functional Shopify store, incorporating essential eCommerce features like product management, payment integration, and customer accounts. Whether you need a direct HTML to Shopify conversion or a complete website redesign, we ensure the final result aligns perfectly with your business goals.
                </p>
                <p>
                  As part of our HTML to Shopify services, we also enhance SEO elements, ensuring that your new Shopify store ranks well on search engines. From meta tags and alt texts to site speed optimization, we ensure your store attracts more organic traffic and converts visitors into loyal customers. By choosing HTML to Shopify migration, you’re giving your business the flexibility, scalability, and security it needs to thrive in the ever-growing online market.
                </p>
              </div>
            </div>
          </div>
                  ...
                  {service.categories.map((category, catIndex) => (
                    <div className="mb-4" key={catIndex}>
                      <h4 className="fw-bold subtitle-heading text-center bg-black px-5 py-2 rounded-5 d-inline-block mx-auto">
                        <a ref={category.subtitleLink} rel="noopener noreferrer" className="text-decoration-none" style={{ color: "#fdfde1" }} >
                          {category.subtitle}
                        </a>
                      </h4>
                      <div className="row">
...
export default Htmltoshopifydetail;
