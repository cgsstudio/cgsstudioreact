...
import SingleImg from "../../assets/images/service/Custom_HTML_Website_Design.jpg";
...
function Customhtmlwebsitedesigndetail() {
  return (
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="aximo-default-content">
                ...
                <p>Our custom-built websites use HTML5 and CSS3, ensuring a lightweight, fast, and scalable structure. We focus on personalized layouts, intuitive navigation, and engaging UI/UX elements that elevate your online presence. Whether you need a business website, a portfolio, or a custom landing page, we design with precision, ensuring an exceptional user experience and higher conversion rates.</p>
              </div>
            </div>
          </div>
...
export default Customhtmlwebsitedesigndetail;
