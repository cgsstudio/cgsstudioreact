    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { text: "Magazine and Booklet Design", link: "/magazine-and-booklet-design-ahmedabad" },
          { text: "Custom Illustration Design", link: "/custom-illustration-design" },
          { text: "Event Invitation Design", link: "/event-invitation-design-ahmedabad" },
          { text: "Menu Design", link: "/menu-design-service-ahmedabad" },
          { text: "Signage Design", link: "/signage-design-service-ahmedabad" },
          { text: "Corporate Profile Design", link: "/corporate-profile-design-ahmedabad" },
          { text: "Annual Report Design", link: "/annual-report-design-agency-ahmedabad" },
          { text: "Digital Ad Design", link: "/digital-ad-design-agency-ahmedabad" },
