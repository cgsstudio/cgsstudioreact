  ...
  return (
    ...
    <Helmet>
     ...
     <div className="container py-5">
      ...
      <p>
        Welcome to our website <a className="text-link-main" href="https://chameleogfxstudio.com/">https://chameleogfxstudio.com/</a>. If you
        continue to browse and use this website, you agree to comply with and be
        bound by the following terms and conditions of use, which, together with
        our privacy policy, govern Chameleo GFX Studio’s relationship with you in
      ...
      <p>
        All trademarks reproduced in this website that are not the property of or
      ...
      <p>
        ...
        without Chameleo GFX Studio’s prior written consent.
      </p>
      <p>
        Your use of this website and any dispute arising out of such use of the
        website is subject to the laws of the Government of India.
      </p>
      <p>
        If you have any questions regarding these Terms & Conditions, please
        contact us at <a className="text-link-main" href="mailto:info@chameleogfxstudio.com">info@chameleogfxstudio.com</a>.
      </p>
    </div>
